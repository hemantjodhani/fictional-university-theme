...
add_filter("pre_get_posts", "university_adjust_queries");
...
add_action('wp_ajax_fetch_posts', 'fetch_posts_ajax');
add_action('wp_ajax_nopriv_fetch_posts', 'fetch_posts_ajax');
